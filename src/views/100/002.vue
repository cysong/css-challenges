<template>
  <div class="frame">
    <div class="center">
      <div class="menu-icon" :class="{ active: isActive }" @click="toggleActive">
        <div :class="{ 'line-1': true, 'no-animation': !isActive }"></div>
        <div :class="{ 'line-2': true, 'no-animation': !isActive }"></div>
        <div :class="{ 'line-3': true, 'no-animation': !isActive }"></div>
      </div>
    </div>
  </div>
</template>
